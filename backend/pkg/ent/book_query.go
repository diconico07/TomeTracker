...
func (_q *BookQuery) QuerySeries() *SeriesQuery {
...
func (_q *BookQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *BookQuery) FirstIDX(ctx context.Context) string {
...
func (_q *BookQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *BookQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *BookQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *BookQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *BookQuery) WithSeries(opts ...func(*SeriesQuery)) *BookQuery {
	query := (&SeriesClient{config: _q.config}).Query()
...
func (_q *BookQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Book, error) {
	...
	if query := _q.withSeries; query != nil {
		if err := _q.loadSeries(ctx, query, nodes, nil,
			func(n *Book, e *Series) { n.Edges.Series = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *BookQuery) loadSeries(ctx context.Context, query *SeriesQuery, nodes []*Book, init func(*Book), assign func(*Book, *Series)) error {
...
func (_q *BookQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withSeries != nil {
			_spec.Node.AddColumnOnce(book.FieldSeriesID)
		}
	}

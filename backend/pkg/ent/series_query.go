...
func (_q *SeriesQuery) QueryBooks() *BookQuery {
...
func (_q *SeriesQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *SeriesQuery) FirstIDX(ctx context.Context) int {
...
func (_q *SeriesQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *SeriesQuery) OnlyIDX(ctx context.Context) int {
...
func (_q *SeriesQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (_q *SeriesQuery) IDsX(ctx context.Context) []int {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *SeriesQuery) WithBooks(opts ...func(*BookQuery)) *SeriesQuery {
	query := (&BookClient{config: _q.config}).Query()
...
func (_q *SeriesQuery) loadBooks(ctx context.Context, query *BookQuery, nodes []*Series, init func(*Series), assign func(*Series, *Book)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(book.FieldSeriesID)
	}
	query.Where(predicate.Book(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(series.BooksColumn), fks...))
	}))
